...
@section('title', 'Philosophy')
  ...
  <div class="container">
    <div class="row">
      <div class="col-2">
        <img src="images/islamic_pattern.png">
      </div>
      <div class="col-8">
        <p><i>[ Space for Ostad Elahi quote. ] "To access the Truth, we must devote ourselves to the pursuit of this knowledge and seek to understand it through practice."</i></p>
      </div>
    </div>
  </div>
